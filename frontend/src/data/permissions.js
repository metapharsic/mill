...
const STORE_NAV = new Set([
  'dashboard', 'store', 'store-dashboard', 'store-reports', 'inbound-dc', 'materials', 'inventory', 'indent', 'rawmaterial', 'purchase', 'vendors', 'reports', 'masterdata', 'machines', 'sections-all',
])
...
const DEPT_GATE = {
  ...
  'inbound-dc':      ['Store Management', 'Inventory', 'Raw Material Store', 'Purchase'],
