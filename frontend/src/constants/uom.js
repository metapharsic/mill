 ...
 * Supports all standard manufacturing, chemical, raw furnish, paper, mechanical & electrical units.
 */
...
// Flat list of all UOM codes for fast validation and mapping
export const ALL_UOM_CODES = UOM_CATEGORIES.flatMap(cat => cat.units.map(u => u.code));

// Default primary fallback list
export const PRIMARY_UOMS = [
  'NOS', 'KGS', 'MT', 'LTR', 'ML', 'GM', 'PKT', 'BOX', 'BAG',
  'DRUM', 'CAN', 'MTR', 'ROLL', 'SET', 'PAIR', 'SHT', 'REAM', 'BALE'
];
